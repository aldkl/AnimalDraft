    ...
    void Update()
    {
        ...
        if (GameMng.Ins.StartCount == 0)
        {
            if (Input.GetKey(KeyCode.R))
            {
                ...
                Quaternion CurObject2 = GameObject.Find("MapChackPoint" + CurLocalNum.ToString()).transform.rotation;
                transform.position = new Vector3(CurObject.x, CurObject.y + 0.3f, CurObject.z);
                transform.rotation = new Quaternion(CurObject2.x, CurObject2.y, CurObject2.z,0);
            }
