...
public class CarCam : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        carPVec3 = new Vector3(0, 0, 0);
    }

    void FixedUpdate()
    {

        //carPVec3 = new Vector3(2, 1, 0);

        Quaternion look;

        // Moves the camera to match the car's position.
        rootNode.position = Vector3.Lerp(rootNode.position + carPVec3, car.position, cameraStickiness * Time.fixedDeltaTime);
